...
class PALACE_Eigenmode_Simulation:
    ...
    def __init__(self, name, metal_design, sim_parent_directory, mode, meshing, user_options={}, view_design_gmsh_gui=False, create_files=True):
        ...
        self.mode = mode
        self.user_options = user_options if user_options else PALACE_Eigenmode_Simulation.default_user_options
...
eigen_sim = PALACE_Eigenmode_Simulation(
    name='single_resonator_example_eigen',
...
eigen_sim.add_metallic(layer_id=1)
